export const GAMES:any = [
    {
        ...
        title:"Temple Run 2",
        tag:"new",
        description:"Play Temple Run 2 Online - Run, jump, turn and slide through the endless landscape once again in this online version of the game Temple Run 2!",
    ...
    },
    {
        ...
        tag:"new",
        description:"Control the assassin and hunt down your targets one by one. Use your surroundings and shadows to stay hidden from flashlights. Targets with automatic machine guns can be lurking around each corner. Attack them swiftly and escape without being spotted.",
        instructions:"Mouse control and touch control on mobile",
